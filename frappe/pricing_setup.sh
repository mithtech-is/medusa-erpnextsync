...
cat > apps/medusync/medusync/handlers/risitex/pricing.py <<'PY'
...
PY
python3 -c "import ast; ast.parse(open('apps/medusync/medusync/handlers/risitex/pricing.py').read()); print('pricing.py OK')"
