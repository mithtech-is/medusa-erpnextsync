...
cat > apps/medusync/medusync/handlers/risitex/reverse.py <<'PY'
...
PY
python3 -c "import ast; ast.parse(open('apps/medusync/medusync/handlers/risitex/reverse.py').read()); print('reverse.py OK')"
