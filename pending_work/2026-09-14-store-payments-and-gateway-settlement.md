...
`../../frappe16/apps/medusync/medusync/invoicing.py` (medusync app) books one Payment Entry per captured store payment
...
- `../../frappe16/apps/medusync/medusync/invoicing.py` (medusync app) — `record_payments`, `_payment_entry`
